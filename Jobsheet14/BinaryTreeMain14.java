...
public class BinaryTreeMain14 {
    public static void main(String[] args) {
        ...
        bst.add(new Student14("244107020138", "Devin", "TI-1I", 3.57));
        bst.add(new Student14("244107020023", "Dewi", "TI-1I", 3.85));
        bst.add(new Student14("244107020225", "Wahyu", "TI-1I", 3.21));
        bst.add(new Student14("244107020076", "Angelina", "TI-1I", 3.54));
